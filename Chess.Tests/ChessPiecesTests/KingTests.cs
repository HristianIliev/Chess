namespace Chess.Tests.ChessPiecesTests
{
    ...
    {
        [Test]
        public void CanDoTheMove_ShouldReturnTrue_WhenTheNewPositionIsOneBlockAwayAndThereIsntAnAllyFigureOnTheNewposition()
        {
            bool expected = true;
            int turn = 0;
            int newCollumn = 6;
            ...
            IPosition positionForSut = new Position(6, 8);
            IChessPiece sut = new King(positionForSut);
        ...
        [Test]
        public void CanDoTheMove_ShouldReturnFalse_WhenTheNewPositionIsNotOneBlockAwayAndThereIsntAnAllyFigureOnTheNewposition()
        {
            bool expected = false;
            int turn = 0;
            int newCollumn = 6;
        ...
        [Test]
        public void CanDoTheMove_ShouldReturnFalse_WhenTheNewPositionIsOneBlockAwayAndThereIsAnAllyFigureOnTheNewposition()
        {
            bool expected = false;
            int turn = 0;
            int newCollumn = 6;
        ...
        [Test]
        public void CheckIfCheck_ShouldReturnTrue_WhenTheKingIsCheck()
        {
            string expected = "Check";
            int turn = 0;
            IList<IChessPiece> blackPieces = this.OrderBlackPieces();
            blackPieces[11].Position.Row += 1;
            IList<IChessPiece> whitePieces = this.OrderWhitePieces();
            whitePieces[3].Position = new Position(2, 5);

            string actual = blackPieces[4].CheckIfCheck(turn, blackPieces, whitePieces);

            StringAssert.Contains(expected, actual);
        }

        [Test]
        public void CheckIfCheck_ShouldReturnFalse_WhenTheKingIsCheck()
        {
            string expected = "Not check";
            int turn = 0;
            IList<IChessPiece> blackPieces = this.OrderBlackPieces();
            blackPieces[11].Position.Row += 1;
            IList<IChessPiece> whitePieces = this.OrderWhitePieces();
            whitePieces[3].Position = new Position(2, 4);
