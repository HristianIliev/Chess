namespace Chess.Tests.ChessPiecesTests
{
    ...
    {
        [Test]
        public void CanDoTheMove_ShouldReturnTrue_WhenTheNewPositionIsOnGAndThereIsntAnAllyFigureOnTheNewPosition()
        {
            bool expected = true;
            int turn = 0;
            int newCollumn = 4;
            ...
            IPosition positionForSut = new Position(3, 8);
            IChessPiece sut = new Knight(positionForSut);
        ...
        [Test]
        public void CanDoTheMove_ShouldReturnFalse_WhenTheNewPositionIsNotOnGAndThereIsntAnAllyFigureOnTheNewPosition()
        {
            bool expected = false;
            int turn = 0;
            int newCollumn = 5;
        ...
        [Test]
        public void CanDoTheMove_ShouldReturnFalse_WhenTheNewPositionIsOnGAndThereIsAnAllyFigureOnTheNewPosition()
        {
            bool expected = false;
            int turn = 0;
            int newCollumn = 5;
